    ...
    fn generate_vec() -> Vec<Card> {
        vec![
            Card {
                ...
                actions: vec![
                    Action::Subtract("$my:resource:mana/10".into()),
                    Action::Add("$my:special:anathema/0.5".into()),
                ],
            ...
            Card {
                ...
                actions: vec![
                    Action::Subtract("$my:resource:faith/10".into()),
            ...
            Card {
                ...
                actions: vec![
                    Action::Subtract("$my:resource:stamina/1".into()),
                    Action::Add("$your:damage:resource:health/2".into()),
                ],
            ...
            Card {
                ...
                actions: vec![
                    Action::Subtract("$my:resource:stamina/5".into()),
                    Action::Add("$your:damage:resource:health/12".into()),
                ],
                tags: vec!["card:type:melee".into()].into(),
            },
        ]
